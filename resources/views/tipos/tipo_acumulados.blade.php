...
@enderror
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="recuencia" name="descripcion_acumulados" required>
                <label for="nombre" class="form-label">Abreviacion del Nuevo Acumulado:</label>
                <input type="text" class="form-control" id="recuencia" name="descripcion_tipo" required>
            </div>  
        </div>
